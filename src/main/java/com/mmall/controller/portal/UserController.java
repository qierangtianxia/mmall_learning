...
public class UserController {
    ...
    public ServerResponse<String> logout(HttpSession session) {
        ...
        return ServerResponse.createSuccessResponse("logout finish");
    }
    ...
    public ServerResponse<User> getUserInfo(HttpSession session) {
        ...
        if (user == null) {
            return ServerResponse.createErrorResponse("user has not login");
        }
    ...
    public ServerResponse<User> getInformation(HttpSession session) {
        User currentUser = (User) session.getAttribute(CURRENT_USER);
        if (currentUser == null) {
            return ServerResponse.createErrorResponse(ResponseCode.NEED_LOGIN.getCode(), "用户未登录，请先登陆");
        }
